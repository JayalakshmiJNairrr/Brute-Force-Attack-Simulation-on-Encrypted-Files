...
## Features
- Cracks **ZIP** and **PDF** files using a brute-force approach
- Utilizes the **RockYou wordlist** for password attempts
- Animated cracking progress with a responsive multithreaded GUI
- Lightweight interface built with **Tkinter**

## Prerequisites
Ensure Python is installed along with the necessary library.
